...
public class Board extends View {
    ...
    private MinMaxActivity activity;
    ...
    public void setMainActivity(MinMaxActivity a) {
        activity = a;
    }

    public void setGameEngine(MinMaxEngine g) {
        gameEngine = g;
    }
    ...
    private void drawElt(Canvas canvas, int c, int x, int y) {
